    ...
    async (conn, mek, m, { args, q, reply }) => {
        try {
            ...
            let message = mentionedUser
                ...
                : `> © Powᴇʀᴇᴅ legend md             const apiUrl = "https://api.waifu.pics/sfw/wave";
            let res = await axios.get(apiUrl);
            let gifUrl = res.data.url;
